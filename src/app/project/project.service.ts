...
export class ProjectService {
    ...
    private completeProjectURL = 'http://localhost/webapi/api/CompleteProject';
    ...
    completeProject(id: number) {
        this.singleProjectURL = this.completeProjectURL + "/" + id;
        return this.http.post(this.singleProjectURL, id);
    }
